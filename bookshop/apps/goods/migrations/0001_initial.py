    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('parent_category', models.ForeignKey(blank=True, db_constraint=False, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='sub_cat', to='goods.goodscategory', verbose_name='父类目级别')),
            ],
            options={
                'verbose_name': '商品类别',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('is_delete', models.BooleanField(default=False, verbose_name='是否删除')),
                ('is_show', models.BooleanField(default=False, verbose_name='是否展示')),
                ('category', models.ForeignKey(db_constraint=False, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='category', to='goods.goodscategory', verbose_name='商品类目')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('category', models.ForeignKey(blank=True, db_constraint=False, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='brands', to='goods.goodscategory', verbose_name='商品类目')),
            ],
            options={
                'verbose_name': '宣传品牌',
        ...
        migrations.AddField(
            model_name='goods',
            name='category',
            field=models.ForeignKey(blank=True, db_constraint=False, null=True, on_delete=django.db.models.deletion.SET_NULL, to='goods.goodscategory', verbose_name='商品类目'),
        ),
    ]
